...
class Draftosaurus extends GBloomDB {
    ...
    public function getUltimaPartida(string $nombre, string $host): array {
        $solicitud = $this->pdo->prepare("select id, fecha, horaInicio, cantidadJugadores from partida where nombre = :nombre and host = :host;");
    ...
    // Esta funcion es exlusivamente para la seguna entrega un jugador
