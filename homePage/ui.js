...
function createAvatarRow(){
    ...
    profilePicture.src = "../Resources/Icons/defaultprofilepic.png";
    profilePicture.alt = "Profile Picture";
    profilePicture.style.width = "50px";  // Set a fixed width for testing
    profilePicture.style.height = "50px";
    const playerName = document.createElement("span");
    playerName.innerText = "PlayerName";

    avatarRow.append(profilePicture, playerName);
    return avatarRow;
}
